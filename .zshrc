...
# Configuración para yewtube
export YEW_PAGER="mpv"
...
alias g='git'
alias z='zathura'
alias lol='php -S localhost:8080' 
alias mpv='/home/ale/.aur/mpv/build/mpv'
alias mp='mpv --vo=kitty'
alias artisan='php artisan serve'
alias sl='slides'
# directory aliases
									...
									function man() {
									  env \
									    ...
									    man "$@"
													    ...
													    if [ "$1" = "h"  ]; then	fzf -m --reverse --preview-window down:20 --preview '[[ $(file --mime {}) =~ binary  ]] &&
